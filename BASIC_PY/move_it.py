...
def program_one():
    rnd_duty = random.uniform(20, 70)
    rnd_time = random.uniform(0.1, 1)
    rnd_wait_end = 0.3
    print("move forward")
    move_forward(random.uniform(20, 70), random.uniform(0.1, 2))
    time.sleep(random.uniform(0.1, rnd_wait_end))
    print("move backward")
    move_backward(random.uniform(20, 70), random.uniform(0.1, 2))
    time.sleep(random.uniform(0.1, rnd_wait_end))
    print("spin left with duty:" + str(rnd_duty))
    spin_left(random.uniform(20, 70), random.uniform(0.1, 1))
    time.sleep(random.uniform(0.1, rnd_wait_end))
    print("move forward")
    move_forward(random.uniform(20, 70), random.uniform(0.1, 2))
    time.sleep(random.uniform(0.1, rnd_wait_end))
    ...
    spin_right(random.uniform(20, 70), random.uniform(0.1, 1))
    time.sleep(random.uniform(0.1, rnd_wait_end))
    print("---------------------")
