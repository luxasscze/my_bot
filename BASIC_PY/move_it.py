...
def program_one():
    ...
    rnd_time = random.uniform(0.1, 2)
    rnd_wait = random.uniform(0, 10)
    print("move forward")
    move_forward(MAIN_DUTY, rnd_time)
    time.sleep(random.uniform(0, 10))
    print("move backward")
    move_backward(MAIN_DUTY, rnd_time)
    time.sleep(random.uniform(0, 10))
    print("spin left with duty:" + str(rnd_duty))
    spin_left(rnd_duty, rnd_time)
    time.sleep(random.uniform(0, 10))
    print("move forward")
    move_forward(MAIN_DUTY, rnd_time)
    time.sleep(random.uniform(0, 10))
